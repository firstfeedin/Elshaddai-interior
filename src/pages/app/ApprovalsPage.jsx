...
const INIT = [
  ...
  { id:'APR-006', type:'PO Approval',        project:'PRJ-0015', projectName:'Sharma Villa',   client:'Rajesh Sharma', submittedBy:'Priya Menon',   date:'2026-06-03', priority:'HIGH',   cost:180000, status:'APPROVED',desc:'Purchase order for teak wood from Bangalore supplier — 240 sqft for master bedroom wardrobes and study.', attachments:['PO-2026-088.pdf'], comments:[{ by:'Admin', text:'PO approved. Placed order.', ts:'2026-06-04' }] },
