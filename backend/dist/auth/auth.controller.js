...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Register new user (any role)' }),
...
__decorate([
    ...
    (0, swagger_1.ApiBearerAuth)(),
    (0, swagger_1.ApiOperation)({ summary: 'Initialise MFA — returns QR code' }),
    __param(0, (0, current_user_decorator_1.CurrentUser)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
...
__decorate([
    ...
    (0, swagger_1.ApiBearerAuth)(),
    (0, swagger_1.ApiOperation)({ summary: 'Confirm MFA TOTP and enable' }),
    __param(0, (0, current_user_decorator_1.CurrentUser)('id')),
